...
@click.option('--precond',       help='Preconditioning & loss function', metavar='vp|ve|edm|denoiser',       type=click.Choice(['vp', 've', 'edm', 'denoiser']), default='edm', show_default=True)
...
def main(**kwargs):
    ...
    elif opts.precond == 'denoiser':
        c.network_kwargs.class_name = 'training.networks.VPPrecond'
        c.loss_kwargs.class_name = 'training.loss.DenoiserError'
    else:
